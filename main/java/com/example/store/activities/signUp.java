    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TextInputEditText nameEditText = (TextInputEditText) name.getEditText();
                TextInputEditText emailEditText = (TextInputEditText) email.getEditText();
                TextInputEditText passwordEditText = (TextInputEditText) password.getEditText();
                TextInputEditText phoneEditText = (TextInputEditText) phone.getEditText();
